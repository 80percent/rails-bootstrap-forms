...
class BootstrapFormTest < ActionView::TestCase
  ...
  test "default-style forms" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" id="new_user" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div></form>}
    assert_equivalent_xml expected, bootstrap_form_for(@user) { |f| nil }
  end

  test "inline-style forms" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form form-inline" id="new_user" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div></form>}
    assert_equivalent_xml expected, bootstrap_form_for(@user, layout: :inline) { |f| nil }
  end

  test "horizontal-style forms" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form form-horizontal" id="new_user" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="form-group"><label class="control-label col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><input class="form-control" id="user_email" name="user[email]" type="email" value="steve@example.com" /></div></div></form>}
  ...
  test "existing styles aren't clobbered when specifying a form style" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form my-style form-horizontal" id="new_user" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="form-group"><label class="control-label col-sm-2 required" for="user_email">Email</label><div class="col-sm-10"><input class="form-control" id="user_email" name="user[email]" type="email" value="steve@example.com" /></div></div></form>}
  ...
  test "given role attribute should not be covered by default role attribute" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" id="new_user" method="post" role="not-a-form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div></form>}
  ...
  test "bootstrap_form_tag acts like a form tag" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="form-group"><label class="control-label" for="email">Your Email</label><input class="form-control" id="email" name="email" type="text" /></div></form>}
  ...
  test "bootstrap_form_tag does not clobber custom options" do
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="form-group"><label class="control-label" for="ID">Email</label><input class="form-control" id="ID" name="NAME" type="text" /></div></form>}
  ...
  test "bootstrap_form_tag allows an empty name for checkboxes" do
    ...
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>#{checkbox}</form>}
  ...
  test "errors display correctly and inline_errors can also be on when label_errors is true" do
    ...
    expected = %{<form accept-charset=\"UTF-8\" action=\"/users\" class=\"rails-bootstrap-forms-form\" id=\"new_user\" method=\"post\" role=\"form\"><div style=\"margin:0;padding:0;display:inline\"><input name=\"utf8\" type=\"hidden\" value=\"&#x2713;\" /></div><div class=\"form-group has-error\"><label class=\"control-label required\" for=\"user_email\">Email can&#39;t be blank, is too short (minimum is 5 characters)</label><input class=\"form-control\" id=\"user_email\" name=\"user[email]\" type=\"text\" /><span class=\"help-block validation-failed-help-block\">can&#39;t be blank, is too short (minimum is 5 characters)</span></div></form>}
  ...
  test "alert_message allows the error_summary to be turned off" do
    ...
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" id="new_user" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="alert alert-danger"><p>Please fix the following errors:</p></div></form>}
    assert_equivalent_xml expected, output
  end
  ...
  test "the field contains the error and is not wrapped in div.field_with_errors when bootstrap_form_for is used" do
    ...
    expected = %{<form accept-charset="UTF-8" action="/users" class="rails-bootstrap-forms-form" id="new_user" method="post" role="form"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="form-group has-error"><label class="control-label required" for="user_email">Email</label><input class="form-control" id="user_email" name="user[email]" type="text" /><span class="help-block">This is required</span><span class="help-block validation-failed-help-block">can&#39;t be blank, is too short (minimum is 5 characters)</span></div></form>}
    assert_equivalent_xml expected, output
  end
  ...
  test "the field is wrapped with div.field_with_errors when form_for is used" do
    ...
    expected = %{<form accept-charset="UTF-8" action="/users" class="new_user" id="new_user" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class="form-group has-error"><div class="field_with_errors"><label class="control-label required" for="user_email">Email</label></div><div class="field_with_errors"><input class="form-control" id="user_email" name="user[email]" type="text" /></div><span class="help-block">This is required</span><span class="help-block validation-failed-help-block">can&#39;t be blank, is too short (minimum is 5 characters)</span></div></form>}
    assert_equivalent_xml expected, output
  end
