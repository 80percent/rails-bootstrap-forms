...
class BootstrapFormGroupTest < ActionView::TestCase
  ...
  test 'form_group renders the "error" class and message corrrectly when object is invalid' do
    ...
    expected = %{<div class="form-group has-error"><p class="form-control-static">Bar</p><span class="help-block validation-failed-help-block">can&#39;t be blank, is too short (minimum is 5 characters)</span></div>}
    assert_equivalent_xml expected, output
  end
